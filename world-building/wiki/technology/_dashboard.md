...
```dataviewjs
const pages = dv.pages('"world-building/wiki/technology"')
  .where(p => !p.file.frontmatter["_author_only"] && p.entity === "technology");
dv.table(["technology", "Total"], [["technology", pages.length]]);
```
