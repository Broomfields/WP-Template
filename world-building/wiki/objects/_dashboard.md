...
```dataviewjs
const pages = dv.pages('"world-building/wiki/objects"')
  .where(p => !p.file.frontmatter["_author_only"] && p.entity === "object");
dv.table(["object", "Total"], [["object", pages.length]]);
```
