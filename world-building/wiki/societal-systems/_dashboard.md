---
title: "Societal Systems Dashboard"
_author_only: true
---

# Societal Systems Dashboard
...
```dataviewjs
const pages = dv.pages('"world-building/wiki/societal-systems"')
  .where(p => !p.file.frontmatter["_author_only"] && p.entity === "societal-system");
dv.table(["societal-system", "Total"], [["societal-system", pages.length]]);
```
